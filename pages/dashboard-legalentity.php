                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                                <div class="modal-header">
                                        <h3 class="modal-title">Add Legal Entity
                                ...
                                <div class="modal-body">
                                        <form action="">
                                                ...
                                                <!-- ADD ADDRESS BUTTON -->
                                                <button class="btn btn-lg btn-success btn-block">Add Address</button>
                                                <br>
                                                ...
                                                <br>
                                                <!-- <div class="col-lg-12"> -->
                                                <button class="btn btn-lg btn-success btn-block">Add Bank Details</button>
                                                <br>
                                                <input class="btn btn-lg btn-primary pull-right" placeholder="Save" value="Submit">
                                            </form>
                                </div>

                                    ...
                                    <div class="carrier">
                                        ...
                                        <div class="carrier-status">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 btn btn-lg"><button class="btn btn-lg btn-block btn-info">UAT</button></div>
                                                <div class="col-lg-3 col-md-3 btn btn-lg"><button class="btn btn-lg btn-block btn-warning">QUA</button></div>
